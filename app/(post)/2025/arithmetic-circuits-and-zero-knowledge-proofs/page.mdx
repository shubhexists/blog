...
The problem with above arithmetic circuits are that is might overflow easily and we won't be able to represent fractions that way. Hence we need finite fields.
...
Eg. 2^3 divided by 3 will give 3.

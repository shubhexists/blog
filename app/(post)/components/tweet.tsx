...
import { Tweet as RTweet, getTweet } from "react-tweet/api";
import {
  EmbeddedTweet,
  TweetNotFound,
  TweetSkeleton,
...
async function getAndCacheTweet(id: string): Promise<RTweet | undefined> {
  ...
  const cachedTweet: RTweet | null = await redis.get(`tweet:${id}`);
